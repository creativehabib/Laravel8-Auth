...
$(function() {
	...
	// author badge :)
	var author = '<div style="position: fixed;bottom: 0;right: 20px;background-color: #fff;box-shadow: 0 4px 8px rgba(0,0,0,.05);border-radius: 3px 3px 0 0;font-size: 15px;padding: 5px 10px;">Created By <a href="https://facebook.com/creativehabibur">@Habibur Rahaman</a> &nbsp;&bull;&nbsp; <a href="https://www.creativehabib.com/">Visit My Website</a></div>';
	$("body").append(author);
